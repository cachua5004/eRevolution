...
namespace eRevolution.Tests
{
    public abstract class eRevolutionTestBase : AbpIntegratedTestBase
    {
        protected eRevolutionTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<eRevolutionApplicationModule>();
            modules.Add<eRevolutionDataModule>();
        }

        public void UsingDbContext(Action<eRevolutionDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<eRevolutionDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<eRevolutionDbContext, T> func)
        {
            T result;
